...
import { draftFields, draftOperations } from './v2/DraftDescription';
import { labelFields, labelOperations } from './v2/LabelDescription';
import { getGmailAliases, getLabels, getThreadMessages } from './v2/loadOptions';
import { messageFields, messageOperations } from './v2/MessageDescription';
import { threadFields, threadOperations } from './v2/ThreadDescription';
...
export class UnitalkGmail implements INodeType {
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		// 	const email: any = createEmail(this);
				...
				if (resource === 'message') {
					...
					if (operation === 'get') {
						...
						if (!simple) {
							...
							const [json] = await simplifyOutput.call(this, [responseData as IDataObject]);
